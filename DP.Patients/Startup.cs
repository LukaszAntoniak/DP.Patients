    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            }).AddJwtBearer(options =>
            {
                ...
                options.Audience = "api://fce95216-40e5-4a34-b041-f287e46532be"; //TenantID: 146ab906-a33d-47df-ae47-fb16c039ef96
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
           {
               c.SwaggerEndpoint("/swagger/v1/swagger.json", "Patient UI");
           });
        }
    }
}
